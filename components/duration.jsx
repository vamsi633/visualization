...
const DurationHistogramChart = ({ data }) => {
  const options = {
    // Type annotation ChartOptions<"bar"> is removed
    responsive: true,
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Distribution of Tox Exposure Duration (in Minutes)",
        color: "white",
        font: {
          size: 18,
        },
      ...
      tooltip: {
        // Add/Modify tooltip for Bar chart
        callbacks: {
...
export default DurationHistogramChart;
